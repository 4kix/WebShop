								...
								<tr>
									...
									<td class="cart_quantity">
										<div class="cart_quantity_button">
											<a class="cart_quantity_up" href="<c:url value="/cart/plus/${sale.product.idOfProduct}"/>"> + </a>
											...
											<c:if test="${sale.amount le 1}">
												<a onclick='return false;' class="cart_quantity_down" href="<c:url value="/cart/minus/${sale.product.idOfProduct}"/>"> - </a>
											</c:if>
											<c:if test="${sale.amount gt 1}">
												<a class="cart_quantity_down" href="<c:url value="/cart/minus/${sale.product.idOfProduct}"/>"> - </a>
											</c:if>
										</div>
									</td>
									<td class="cart_total">
									...
									<td class="cart_delete">
										<a class="cart_quantity_delete" href="<c:url value="/cart/remove/${sale.product.idOfProduct}"/> "><i class="fa fa-times"></i></a>
									</td>
								</tr>
							</c:forEach>
						</tbody>

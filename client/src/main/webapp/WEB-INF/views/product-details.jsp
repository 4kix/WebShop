			...
			<div class="row">
				...
				<div class="col-sm-9 padding-right">
					<div class="product-details"><!--product-details-->
						<div class="col-sm-5">
							<div class="view-product">
								<img src="<c:url value="/image/${product.idOfProduct}"/>" alt="" />
							</div>
							...
							<div class="product-information"><!--/product-information-->
								...
								<span>
									...
									<form action="<c:url value="/cart/addAmount"/>" method="post">
										...
										<input type="hidden" name="id" value="${product.idOfProduct}">
										...
										<br>
										<br>
										<button class="btn btn-fefault cart-prod" type="submit">

											Добавить в корзину
										</button>
									</form>
								</span>
								<p><b>Тип:</b> ${product.type.nameOfType}</p>
								<p><b>Производитель:</b> ${product.country.nameOfCountry}</p>
					...
					<div class="recommended_items"><!--recommended_items-->
						<h2 class="title text-center">рекомендуемые вам</h2>
						<div id="recommended-item-carousel" class="carousel slide" data-ride="carousel">
							<div class="carousel-inner">
								<div class="item active">
									<c:forEach items="${recommendedProducts1}" var="product">
										<a href="<c:url value="/product-details/${product.idOfProduct}"/>">
											<div class="col-sm-4">
												<div class="product-image-wrapper">
													<div class="single-products">
														<div class="productinfo text-center">
															<img src="/image/${product.idOfProduct}" alt="" />
								...
								<div class="item">
									<c:forEach items="${recommendedProducts2}" var="product">
										<a href="<c:url value="/product-details/${product.idOfProduct}"/>">
											<div class="col-sm-4">
												<div class="product-image-wrapper">
													<div class="single-products">

					...
					<div class="col-sm-6 ">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href=""><i class="fa fa-phone"></i> +375(44)-716-77-48</a></li>
								<li><a href=""><i class="fa fa-envelope"></i> falko.ilya@gmail.com</a></li>
								<li><a href=""><i class="fa fa-envelope"></i> i.pahotnyh@gmail.com</a></li>
							</ul>
						</div>
					</div>
					</div>
							...
							<ul class="nav navbar-nav">
								...
								<c:if test="${user ne 'anonymousUser'}">
									<li><p>Добро пожаловать, ${user}</p>
										<a href="<c:url value="/logout" />">Выйти</a></li>
								</c:if>
							</ul>
						</div>
					</div>

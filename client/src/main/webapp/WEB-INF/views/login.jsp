						...
						<form action="${loginUrl}" method="post">
							...
							<c:if test="${param.logout != null}">
								<div class="alert alert-success">
									<p>Вы вышли из учетной записи.</p>
								</div>
							</c:if>
				...
				<div class="col-sm-4">
					<div class="signup-form"><!--sign up form-->
						...
						<springform:form commandName="userReg" action="/register" method="post">
							...
							<label>&nbsp;<springform:errors path="username" cssClass="error"/></label>
							<springform:input type="password" path="password" placeholder="Пароль *"/>
							<label>&nbsp;<springform:errors path="password" cssClass="error"/></label>
							<springform:input type="password" path="confirmPassword" placeholder="Повторите пароль *"/>
							<label>&nbsp;<springform:errors path="confirmPassword" cssClass="error"/></label>
							...
							<label>&nbsp;<springform:errors path="phone" cssClass="error"/></label>
